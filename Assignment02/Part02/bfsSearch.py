...
def bfs(graph, start, end):
    ...
    while len(openList) > 0:
        ...
        # Add the current node to the closedList list
...
def main():
    ...
    for i in range(len(myData)):
        ...
        # myThirdData.append(mySecondData[i].split(","))
    

    # print(mySecondData[51].replace("(","").replace(", "," ").replace("'","").split(" "))
    ...
    #     # myThirddata = mySecondData[j].replace("(","").replace(", "," ").replace("'","").split(" ")
        

    #     # myThirddata = [item.replace("(","").replace(", "," ").replace("'","").split(" ") for item in mySecondData[j]] 

        
    #     for item in mySecondData[j]:
    #         print(item.replace("(","").replace(", "," ").replace("'","").split(" "))
                 

    #     # print(myThirddata[0])

    #     item_01 = myThirddata[0]
    #     item_02 = myThirddata[1]
    #     item_03 = int(myThirddata[2])
        
    #     graph.connect(item_01,item_02,item_03)
    #     print(item_01)
    #     print(item_02)
    #     print(item_03)
